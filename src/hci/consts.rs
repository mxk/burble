...
#[repr(transparent)]
pub struct CompanyId(pub(crate) u16);
...
impl Debug for CompanyId {
    ...
    fn fmt(&self, f: &mut Formatter<'_>) -> std::fmt::Result {
        ...
        f.debug_tuple(name_of!(CompanyId))
...
id_map! {
    ...
    0x0031 => "Synopsys, Inc.",
    0x0032 => "RedM (Communications) Ltd",
    0x0033 => "Commil Ltd",
    ...
    0x005A => "EM MicroelectronicMarin SA",
    ...
    0x00AB => "IngenieurSystemgruppe Zahn GmbH",
    ...
    0x00BB => "SPower Electronics Limited",
    ...
    0x00EA => "NielsenKellerman Company",
    ...
    0x01FD => "Kontakt MicroLocation Sp. z o.o.",
    ...
    0x0275 => "Geotab",
    0x0276 => "E.G.O. ElektroGeraetebau GmbH",
    0x0277 => "bewhere inc",
    ...
    0x03AD => "XiQ",
    0x03AE => "Allswell Inc.",
    0x03AF => "CommNSense Corp DBA Verigo",
    ...
    0x03FB => "Nox Medical",
    0x03FC => "KimberlyClark",
    0x03FD => "Trimble Navigation Ltd.",
    0x03FE => "Littelfuse",
    0x03FF => "Withings",
    0x0400 => "ideveloper IT Beratung UG",
    ...
    0x046D => "BEGA GantenbrinkLeuchten KG",
    0x046E => "Pambor Ltd.",
    0x046F => "Develco Products A/S",
    0x0470 => "iDesign s.r.l.",
    0x0471 => "TiVo Corp",
    0x0472 => "ControlJ Pty Ltd",
    ...
    0x05BF => "RealWorldSystems Corporation",
    ...
    0x0605 => "FMW electronic Futterer u. MaierWolf OHG",
    0x0606 => "John Deere",
    ...
    0x0618 => "AudioTechnica Corporation",
    ...
    0x062C => "ASPion GmbH",
    0x062D => "VosslohSchwabe Deutschland GmbH",
    0x062E => "Procept",
    ...
    0x0652 => "ITZ Innovationsund Technologiezentrum GmbH",
    0x0653 => "Meggitt SA",
    ...
    0x0666 => "WTO WerkzeugEinrichtungen GmbH",
    ...
    0x06A8 => "GD Midea AirConditioning Equipment Co., Ltd.",
    ...
    0x0794 => "The CocaCola Company",
    0x0795 => "GASTEC CORPORATION",
    0x0796 => "StarLeaf Ltd",
    0x0797 => "Wateri.d. GmbH",
    0x0798 => "HoloKit, Inc.",
    ...
    0x0862 => "SmartDrive",
    0x0863 => "Yotronics Technology Co., Ltd.",
    0x0864 => "Rafaelmicro",
    ...
    0x0887 => "HydroGear Limited Partnership",
    ...
    0x089D => "JJ.A.D.E. Enterprise LLC",
    0x089E => "iSENS, inc.",
    ...
    0x0901 => "Lucimed",
    0x0902 => "TSC AutoID Technology Co., Ltd.",
    0x0903 => "DATAMARS, Inc.",
    ...
    0x092A => "Sappl Verwaltungsund Betriebs GmbH",
    0x092B => "TekHome",
    ...
    0x0994 => "VT42 Pty Ltd",
    0x0995 => "Bronkhorst HighTech B.V.",
    ...
    0x0A46 => "Beijing HCInfinite Technology Limited",
    ...
    0x0A97 => "SensTek",
    0x0A98 => "Foil, Inc.",
    0x0A99 => "Shanghai highflying electronics technology Co.,Ltd",
    ...
    0x0B28 => "CHACON",
    0x0B29 => "TechVenom Entertainment Private Limited",
    ...
    0x0B5D => "Fujian Newland AutoID Tech. Co., Ltd.",
