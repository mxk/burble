...
impl IoCap {
    ...
    #[inline(always)]
    pub fn new(auth_req: impl Into<u8>, oob: bool, io_cap: impl Into<u8>) -> Self {
        Self([auth_req.into(), u8::from(oob), io_cap.into()])
    }
}
...
// TODO: Is constant-time comparison required for Passkey Entry protocol?
impl ConstantTimeEq for Confirm {
    #[inline(always)]
